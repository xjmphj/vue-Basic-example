<template>
  <transition :name="isTop ? 'fade' : needReverse ? 'right-in' : 'left-in'">
    ...
    >
      ...
      >
        <!-- 添加 -->
        <img class="thumbnail" referrerpolicy="no-referrer" :src="item.imgurl" v-if="item.imgurl" />
        <!-- <svg-icon name="company" className="icon" /> -->
...
// import { CirclePlus, Rank, EditPen, DeleteFilled } from '@element-plus/icons-vue';
